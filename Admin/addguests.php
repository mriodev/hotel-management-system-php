...
<body>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-10 shadow-sm" style="margin-top: 100px;">
                    <form id="form" action="" method="post" enctype="multipart/form-data">
                        <h3 class="text-center my-3">Guest Registration</h3>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                placeholder="Enter NIC / Passport No" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <input type="int" name="brno" maxlength="10" id="brno" class="form-control" 
    ...
    if (isset($_POST["register"])) {
        ...
        if ($check_email > 0) {
            ...
            $query = "INSERT INTO users(profile,first_name,last_name,mobile,email,role,password) 
            VALUES('$profile','$first_name', '$last_name', '$mobile', '$email','$role', '$password')";
