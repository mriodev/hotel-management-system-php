...
if (isset($_POST["submit"])) {
    ...
    $res_id = mysqli_query($connect, $guest_id);
    $rowww=mysqli_fetch_array($res_id);
    $vall=$rowww[0];


    
    $query = "INSERT INTO reservation (cus_id,hotelid,roomtype_id,checkindate,checkoutdate,reservedate,noofrooms,noofoccupants,totalamount,status,clubcharge,laundrycharge,restaurantcharge,roomservice,telephonecharge,room_id) VALUES('$vall', '$location', '$roomtype', '$checkindate', '$checkoutdate', '$reservedate', '$noofrooms', '$noofoccupants', '$totalamount', '$status','$club','$laundry','$restaurant','$roomservice','$telephone','$room_id')";
