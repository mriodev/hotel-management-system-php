...
<body>
                ...
                <form id="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3 text-center mb-5">
                                <label for="emp_image" style="cursor:pointer" class="avatar avatar-xl">
                                    <?php if (empty($profile)) : ?>
                                        <img id="profilePicture" style="height: 100px; width: 100px;" class="avatar-img rounded-circle"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="emp_fname" class="form-control" id="emp_fname" autocomplete="off" value="<?php echo $fname ?>" 
                                placeholder="Enter first name">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="emp_lname" class="form-label">Last Name</label>
                                <input class="form-control" id="emp_lname" name="emp_lname" autocomplete="off" value="<?php echo $lname ?>"
                                 placeholder="Enter last name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="emp_email" class="form-label">Email address</label>
                            <input type="email" name="emp_email" class="form-control" id="emp_email" autocomplete="off" value="<?php echo $email ?>"
                            placeholder="Enter email address">
                        </div>
                        <div class="form-group">
                            <label for="emp_mobile" class="form-label">Mobile Number</label>
                            <input class="form-control" id="emp_mobile" name="emp_mobile" value="<?php echo $mobile ?>"
                             placeholder="Enter mobile number" maxlength="10">
                        </div>

                        <div class="form-group">
                            <label for="emp_username" class="form-label">Username</label>
                            <input type="username" name="emp_username" class="form-control" id="emp_username" autocomplete="off" value="<?php echo $username ?>"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="old_emp_password" class="form-control" id="old_emp_password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="c_emp_password" class="form-control" id="password" 
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "update user set fname='$e_fname',lname='$e_lname',mobile='$e_mobile',email='$e_email',username='$e_username',
        profile='$e_image' where id='$set_id'";
    ...
    if (isset($_POST['submitPass'])) {
        ...
        $queryPass = "update user set password='$e_password' where id='$set_id'";
