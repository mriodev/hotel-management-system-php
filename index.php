				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#ourservices" class="menu__link scroll">Our Services</a></li>
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Gallery</a></li>
							<li class="menu__item"><a href="#visitors" class="menu__link scroll">Visitors And Reviews</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>QUEENSBURY    <span>HOTELS</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">QUEENSBURY HOTELS</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<div class="plans-section" id="rooms">
				 ...
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						...
						<?php if (!empty($image)) : ?>
                                    <img src="./Admin/images/<?php echo $image ?>" style="border-radius: 10px;" class="card-img-top" height="300px">
                                <?php else : ?>
                                    <img src="./Admin/images/room.jpeg" class="card-img-top" height="300px">
                                <?php endif ?>
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								...
								<a href="addreservations.php?id=<?php echo $row['tname']; ?>">Book Now</a>
							</div>
						</div>
					</div>
	 ...
	 <!--// rooms & rates -->
<!--sevices-->
<div class="advantages" id="ourservices">
	<div class="container">
...
<!-- //gallery -->
  ...
  <!-- visitors -->
  <section class="portfolio-w3ls" id="visitors">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@QUEENSBURY.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Galleface, Colombo, Sri Lanka</p>
